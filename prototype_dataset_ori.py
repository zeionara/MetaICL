...
def main(logger, args):
    ...
    train_data = utils.data.load_data(args.task, "train", args.k, seed=args.seed,
    ...
    # num_tasks = len(train_data)

    # if args.local_rank <= 0:
    #     for task_name, task_data in train_data.items():
    #         logger.info(f"[Train] {task_name}\t{len(task_data)}")
